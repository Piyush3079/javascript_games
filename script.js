$(function(){
	$('.X').click(function(){
		...
		if(x == "X"){
			$('#player_1').text('Player 1 is '+' : '+ ' '+' '+x);
			$('#player_2').text('Player 2 is '+' : '+ ' '+' '+'O');
		}
		else{
			$('#player_1').text('Player 1 is '+' : '+ ' '+' '+x);
			$('#player_2').text('Player 2 is '+' : '+ ' '+' '+'X');
		}
		...
		$('.col-md-4').click(function(){
			...
			var turn = $('#turn').text();
			if(initial_check == ""){
				if($('#turn').text() == "Player 1 turn" && x=="X"){
					$(this).children().text("X");
				}
				else if($('#turn').text() == "Player 1 turn" && x=="O"){
					$(this).children().text("O");
				}
				else if($('#turn').text() == "Player 2 turn" && x=="X"){
					$(this).children().text("O");
				}
				else if($('#turn').text() == "Player 2 turn" && x=="O"){
					$(this).children().text("X");
				}
			...
			if(length == 9){
				alert("The game is draw between you two. Try again...");
				window.location = "index.html";
			}
		});
	});
